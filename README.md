...
- 📧 [emailcn](https://github.com/shadcn-labs/emailcn): email components for React, built on React Email, MJML React and JSX Email. `67 ★`
- 📄 [pdfcn](https://github.com/shadcn-labs/pdfcn): PDF components for React, built on Takumi and Forme. `451 ★`
...
- ▲ [Soubi](https://github.com/tarkaworks/soubi) - Next.js for agent plugins. `7 ★`
- 🥞 [Foldocs](https://github.com/tarkaworks/foldocs) - Beautiful & flexible docs framework based on Foldkit and Effect. `19 ★`
- 🏮 [Ngxdocs](https://github.com/tarkaworks/ngxdocs) - Beautiful & flexible docs framework based on AnalogJS and AngularJS. `0 ★`
